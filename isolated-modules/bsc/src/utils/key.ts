...
export function convertExtendedSecretKey(
  ...
  switch (extendedSecretKey.format) {
    ...
    default:
      ...
      throw new UnsupportedError(Domain.ETHEREUM, 'Unsupported extended secret key format.')
  }
}
...
export function convertExtendedPublicKey(
  ...
  switch (extendedPublicKey.format) {
    ...
    default:
      ...
      throw new UnsupportedError(Domain.ETHEREUM, 'Unsupported extended public key format.')
  }
}
