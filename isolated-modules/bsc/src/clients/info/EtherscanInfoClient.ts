...
import { BSCInfoClient, BSCInfoClientTransaction, BSCInfoClientTransactionsResult } from './BSCInfoClient'

export class EtherscanInfoClient extends BSCInfoClient {
  ...
  public async fetchTransactions(
    ...
    const airGapTransactions: BSCInfoClientTransaction[] = []
    ...
    for (const transaction of transactions) {
      ...
      const airGapTransaction: BSCInfoClientTransaction = {
